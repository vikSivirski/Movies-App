...
class MoviesListItem extends Component {
  ...
  handleRateChange = (value) => {
    ...
    fetch(
      `https://api.themoviedb.org/3/movie/${movieId}/rating?api_key=8490441a780d696323472e0a8e97e0ca&guest_session_id=${guestSessionId}`,
      {
        method: "POST",
        headers: {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {rating > 0 && <RatingCircle rating={rating} />}
      </Card>
    );
  }
}
